        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                @if($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{ action('AdminController@countryMetaDescPost') }}" method="post">
                    ...
                    <div>
                    <textarea name="content" id="content" class="textarea form-control" placeholder="اضافة محتوى جديد"
                              rows="7"></textarea>
                    </div>
                ...
                <script>
                    $("#langCode").keyup(function () {
                        ...
                        var url = "/admin/get-country-meta-desc-content/" + locale;
                        $.ajax({
                            url: url,
