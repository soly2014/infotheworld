    ...
    <div class="col-lg-10 col-lg-offset-1">
        <div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title">تحديث القسم</h3>
                <!-- tools box -->
            ...
            <div class="box-body">
                ...
                @if($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{ action('AdminController@addHomeSectionPost') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="title" class="form-control" type="text" max="2" name="title">
                    </div>
                    <div class="form-group">
                        <label>المحتوى</label>
                ...
                <script>
                    $("#langCode").keyup(function () {
                        ...
                        var url = "/admin/get-home-secton-content/" + locale;
                        $.ajax({
                            url: url,
