        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                @if($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{ action('AdminController@countryMetaKeyPost') }}" method="post">
                    ...
                    <div>
                        <textarea name="content" id="content" class="textarea form-control"
                                  rows="10" placeholder="المحتوى"></textarea>
                    </div>
                ...
                <script>
                    $("#langCode").keyup(function () {
                        ...
                        var url = "/admin/get-country-meta-key-content/" + locale;
                        $.ajax({
                            url: url,
