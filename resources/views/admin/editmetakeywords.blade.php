        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                @if($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{ action('AdminController@editMetaKeywordsPost') }}" method="post">
                    ...
                    <div>
                    <textarea name="content" id="content" class="textarea form-control" placeholder="المحتوى"
                              rows="10"></textarea>
                    </div>
                ...
                <script>
                    $("#langCode").keyup(function () {
                        ...
                        var url = "/admin/get-meta-key-content/" + locale;
                        $.ajax({
                            url: url,
